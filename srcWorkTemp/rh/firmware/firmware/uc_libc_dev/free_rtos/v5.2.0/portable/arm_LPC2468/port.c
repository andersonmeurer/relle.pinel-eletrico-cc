...
extern n32 irq_Install(u32 int_number, void *handler_addr, u32 priority);
...
static void prvSetupTimerInterrupt( void )
{
	...
	// Setup the VIC for the timer. The ISR installed depends on whether the preemptive or cooperative scheduler is being used.
	#if configUSE_PREEMPTION == 1
	{
		extern void ( vPreemptiveTick )( void );
		irq_Install(VIC_TIMER0, vPreemptiveTick, FREERTOS_PRIO_LEVEL);
	}
	#else
	{
		extern void ( vNonPreemptiveTick )( void );
		irq_Install(VIC_TIMER0, vNonPreemptiveTick, FREERTOS_PRIO_LEVEL);
	}
	#endif
