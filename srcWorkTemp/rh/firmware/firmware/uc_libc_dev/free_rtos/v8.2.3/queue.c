...
QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, const u8 ucQueueType )
{
Queue_t *pxNewQueue;
...
/*-----------------------------------------------------------*/
	...
	QueueHandle_t xQueueCreateMutex( const u8 ucQueueType )
	{
	Queue_t *pxNewQueue;
...
/*-----------------------------------------------------------*/
	...
	u8 ucQueueGetQueueType( QueueHandle_t xQueue )
	{
