...
#define UART0_RX_BUFFER_SIZE 	150			// Somente para uart com interrupção
#define UART0_TX_BUFFER_SIZE 	150			// Somente para uart com interrupção
...
#define UART1_RX_BUFFER_SIZE 150			// Somente para uart com interrupção
#define UART1_TX_BUFFER_SIZE 150			// Somente para uart com interrupção
...
// UART2
	...
	#define UART2_RX_BUFFER_SIZE 150		// Somente para uart com interrupção
	#define UART2_TX_BUFFER_SIZE 150		// Somente para uart com interrupção
...
// UART3
	...
	#define UART3_RX_BUFFER_SIZE 150		// Somente para uart com interrupção
	#define UART3_TX_BUFFER_SIZE 150	// Somente para uart com interrupção
