...
#define SYSTIME_LED_DIR		GPIO1_DIR
#define SYSTIME_LED_OFF		GPIO1_CLR
#define SYSTIME_LED_ON		GPIO1_SET
#define SYSTIME_LED			BIT_0

#define ERROR_LED_DIR		GPIO1_DIR
#define ERROR_LED_OFF		GPIO1_CLR
#define ERROR_LED_ON		GPIO1_SET
#define ERROR_LED			BIT_0

// ###################################################################################################################
// ADC e DAC
#define ADC0_ConfigPort()		{ PINSEL3 |= 0xF0000000; PINSEL1 |= 0x40000;} 	// Ajustar o P1_31 para (AD0[5]), P1_30 para (AD0[4]) e P0_25 para AD0[2]
#define ADC0_DisablePulls()		{ PINMODE3 |= 0xA0000000; PINMODE1 |= 0x80000;}	// pino P1_31 (AD0[5]), P1_30 (AD0[4]) e P0_25 (AD0[2]) sem pulls
...
// Seleção de função
#define jmpMODE_PIN			GPIO2_PIN
#define jmpMODE_NUMPIN		BIT_0

#define jmpMODBUS_PIN		GPIO0_PIN
#define jmpMODBUS_NUMPIN	BIT_6

#define jmp6_PIN			GPIO2_PIN
#define jmp6_NUMPIN			1
