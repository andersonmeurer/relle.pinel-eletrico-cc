...
#define SPI1_BASE_ADDR		0xE0030000

#define SPI1_SLAVE	0
#define SPI1_MASTER	1 
	
#define S1SPCR         (*(reg32 *)(SPI1_BASE_ADDR + 0x00))	// Control Register
	#define SPI1_CPHA	(1<<3)									// Este bit em 0 configura a captura o dado na primeira borda do clock, bit 1 captura na segunda borda
	#define SPI1_CPOL	(1<<4)									// Este bit em 0 configura o padrão do clock em 0, bit 1 o padrão em 1
	#define SPI1_MSTR	(1<<5)									// Este bit em 0 ajusta o ARM como escravo, bit 1 como mestre
	#define SPI1_LSBF	(1<<6)									// Este bit em 0 o primeiro bit a TX será o MSB, o bit 1 será LSB
	#define SPI1_SPIE 	(1<<7)									// Este bit em 0 desabilita a interrupção, bit 1 habilita
	#define SPI1_STANDARD 0

#define S1SPSR         (*(reg32 *)(SPI1_BASE_ADDR + 0x04))	// Status Register
	#define SPI1_ABRT 	(1<<3)									// Este bit em 1 indica que o escravo abortou a recepção do dado
	#define SPI1_MODF 	(1<<4)									// Este bit em 1 indica que ocorreu o modo fault. Este modo ocorre quando existe uma falha no módulo SPI
	#define SPI1_ROVR 	(1<<5)									// Este bit em 1 indica que o overrun, ou seja, o dado foi recebido de maneira incorreta
	#define SPI1_WCOL 	(1<<6)									// Este bit em 1 indica que ocorre uma colisão de dados, ou seja, recebeu um novo dados sem ler o anterior
	#define SPI1_SPIF 	(1<<7)									// Este bit em 1 indica que houve uma transferencia completa dos dados

#define S1SPDR         (*(reg32 *)(SPI1_BASE_ADDR + 0x08))	// Data Register
#define S1SPCCR        (*(reg32 *)(SPI1_BASE_ADDR + 0x0C))  // Clock Counter Register
#define S1SPINT        (*(reg32 *)(SPI1_BASE_ADDR + 0x1C))	// Interrupt Flag Register
...
#define IO2PIN         (*(reg32 *)(GPIO_BASE_ADDR + 0x20))	// P2 - Registrador de leitura da porta
#define IO2SET         (*(reg32 *)(GPIO_BASE_ADDR + 0x24))	// P2 - Registrador para acionar os pinos da porta. 1 = Aciona, 0 = Sem efeito 
#define IO2DIR         (*(reg32 *)(GPIO_BASE_ADDR + 0x28))	// P2 - Registrador para determinar o sentido dos pinos da porta. 1 = Saida  0 = Entrada
#define IO2CLR         (*(reg32 *)(GPIO_BASE_ADDR + 0x2C))	// P2 - Registrador para desligar os pinos da porta. 1 = Desliga, 0 = Sem efeito

#define IO3PIN         (*(reg32 *)(GPIO_BASE_ADDR + 0x30))	// P3 - Registrador de leitura da porta
#define IO3SET         (*(reg32 *)(GPIO_BASE_ADDR + 0x34))	// P3 - Registrador para acionar os pinos da porta. 1 = Aciona, 0 = Sem efeito 
#define IO3DIR         (*(reg32 *)(GPIO_BASE_ADDR + 0x38))	// P3 - Registrador para determinar o sentido dos pinos da porta. 1 = Saida  0 = Entrada
#define IO3CLR         (*(reg32 *)(GPIO_BASE_ADDR + 0x3C))	// P3 - Registrador para desligar os pinos da porta. 1 = Desliga, 0 = Sem efeito
...
#define AD0CR          	(*(reg32 *)(AD0_BASE_ADDR + 0x00))	// Control Register
	...
	#define AD0_CHANNEL_MASK	(0xFF)
  	...
  	#define AD0_START_NOW		( 1 << 24 )							// Somente no modo não BUSRT. Incializa conversão agora
  	#define AD0_START_MAT0_0 	( 3 << 24 )						// Somente no modo não BUSRT. Incializa conversão pela mudança da borda do pino MAT0.0
  	#define AD0_START_MAT0_1 	( 4 << 24 )						// Somente no modo não BUSRT. Incializa conversão pela mudança da borda do pino MAT0.1
  	#define AD0_START_MAT0_2 	( 2 << 24 )						// Somente no modo não BUSRT. Incializa conversão pela mudança da borda do pino MAT0.2
  	#define AD0_START_MAT0_3 	( 5 << 24 )						// Somente no modo não BUSRT. Incializa conversão pela mudança da borda do pino MAT0.3
  	#define AD0_START_MAT1_0 	( 6 << 24 )						// Somente no modo não BUSRT. Incializa conversão pela mudança da borda do pino MAT1.0
  	#define AD0_START_MAT1_1 	( 7 << 24 )						// Somente no modo não BUSRT. Incializa conversão pela mudança da borda do pino MAT1.1
...
#define AD0DR         	(*(reg32 *)(AD0_BASE_ADDR + 0x04))	// Data Register
...
#define EMC_BASE_ADDR		0xFFE00000

// External Memory Controller Registers
#define BCFG0          (*(reg32 *)(EMC_BASE_ADDR + 0x00))     	// Registrador de configuração do banco 0
#define BCFG1          (*(reg32 *)(EMC_BASE_ADDR + 0x04))		// Registrador de configuração do banco 1
#define BCFG2          (*(reg32 *)(EMC_BASE_ADDR + 0x08))		// Registrador de configuração do banco 2
#define BCFG3          (*(reg32 *)(EMC_BASE_ADDR + 0x0C))		// Registrador de configuração do banco 3
