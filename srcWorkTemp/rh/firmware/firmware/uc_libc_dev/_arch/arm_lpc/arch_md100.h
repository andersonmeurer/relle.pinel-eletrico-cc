#ifndef __ARCH_ARCH_KITLPC175xMD100_H
#define __ARCH_ARCH_KITLPC175xMD100_H
...
#define MISC_LED_DIR		LED2_DIR
#define MISC_LED_OFF		LED2_OFF
#define MISC_LED_ON			LED2_ON
#define MISC_LED			LED2

#define ERROR_LED_DIR		LED2_DIR
#define ERROR_LED_OFF		LED2_OFF
#define ERROR_LED_ON		LED2_ON
#define ERROR_LED			LED2

#define SYSTIME_LED_DIR		LED1_DIR
#define SYSTIME_LED_OFF		LED1_OFF
#define SYSTIME_LED_ON		LED1_ON
#define SYSTIME_LED			LED1

// ###################################################################################################################
// ADC e DAC

#define ADC0_ConfigPort()		{ PINSEL1 |= 0x140000; PINMODE1 |= 0x280000;} 	// pino P0_25 como AD0[2] e pino P0_26 como AD0[3]
