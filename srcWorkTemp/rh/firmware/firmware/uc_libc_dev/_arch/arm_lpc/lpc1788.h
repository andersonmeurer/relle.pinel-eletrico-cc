...
#define SRAM_BANK0_BASE_ADDR		0x80000000UL // 0x80000000 - 0x83ffffff
#define SRAM_BANK1_BASE_ADDR		0x90000000UL // 0x90000000 - 0x93ffffff
#define SRAM_BANK2_BASE_ADDR		0x98000000UL // 0x98000000 - 0x9bffffff
#define SRAM_BANK3_BASE_ADDR		0x9c000000UL // 0x9c000000 - 0x9fffffff

#define SDRAM_BANK0_BASE_ADDR		0xa0000000 // 0xa0000000 - 0xafffffff
#define SDRAM_BANK1_BASE_ADDR		0xb0000000UL // 0xb0000000 - 0xbfffffff
#define SDRAM_BANK2_BASE_ADDR		0xc0000000UL // 0xc0000000 - 0xcfffffff
#define SDRAM_BANK3_BASE_ADDR		0xd0000000UL // 0xd0000000 - 0xdfffffff
...
#define PWM0IR          (*(reg32 *)(PWM0_BASE_ADDR + 0x00))			//  Interrupt Register
	...
	#define PW0MIR_MASK  (0x073F)

#define PWM0TCR         (*(reg32 *)(PWM0_BASE_ADDR + 0x04))        	// Timer Control Register
	#define PWM0TCR_ENABLE  (1 << 0)								// Habilita o contador do timer
	#define PWM0TCR_STOP    (0)										// Desabilita o contador do timer
	#define PWM0TCR_RESET   (1 << 1)								// Zera o contador do timer
	#define PWM0TCR_PWMEN   (1 << 3)								// Habilita modo PWM
...
// ########################################################################################################################################
// SETUP FAST I/O datasheet pagina 133
// Usados quando a função do pino (IOCON) é 1 (GPIO)
#define FIO_BASE_ADDR		0x20098000UL
