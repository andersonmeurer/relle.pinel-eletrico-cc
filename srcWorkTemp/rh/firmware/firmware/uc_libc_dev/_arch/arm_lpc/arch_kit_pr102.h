#ifndef __ARCH_ARCH_KITLPC175xPR102_H
#define __ARCH_ARCH_KITLPC175xPR102_H
...
// 		Deve ser divisor inteiro de F_CPU por 1, 2, 4 ou 8
...
//		PLL_N deve ficar entre 1 a 256.
...
// SSP1: CLK=P0_6, SSEL=P0_7 (usar como GPIO), MISO=P0_8 e MOSI=P0_9
#define ssp1_ConfigPort() 	{ PINSEL0 |= 0xAA000;}
...
// TIMER2
// LPC175x MATCH0 = P0_6 TODO - valores temporários
#define MATCH2_ConfigPort0() 		{ PINSEL0 |= 0x3000; }
// LPC175x MATCH1 = P0_7 TODO - valores temporários
#define MATCH2_ConfigPort1()		{ PINSEL3 |= 0xC000; }

// ###################################################################################################################
// CONFIGURAÇÕES DOS LEDS
#define LED1_DIR			GPIO1_DIR
#define LED1_OFF			GPIO1_CLR
#define LED1_ON				GPIO1_SET
#define LED1				(1<<19)

#define LED2_DIR			GPIO1_DIR
#define LED2_OFF			GPIO1_CLR
#define LED2_ON				GPIO1_SET
#define LED2				(1<<18)
...
#define MISC_LED_OFF		LED1_OFF
#define MISC_LED_ON			LED1_ON
#define MISC_LED			LED1

#define LED_ERROR_DIR		LED2_DIR
#define LED_ERROR_OFF		LED2_OFF
#define LED_ERROR_ON		LED2_ON
...
#define ADC0_ConfigPort()		{ PINSEL1 |= 0x40000; PINSEL3 |= 0xC0000000;} 	// pino P0_25 como AD0[2] e pino P1_31 como AD0[5]
#define ADC0_DisablePulls()		{ PINMODE1 |= 0x280000;} 	// pino P0_25 como AD0[2] e pino P0_26 sem pullup e pulldown

// ###########################################################################################################################################
// CONFIGURAÇÕES DOS SWITCHS
#define SW0_DIR				GPIO1_DIR
#define SW0_PIN				GPIO1_PIN
#define SW0_NUMPIN			(1<<22)

#define SW1_DIR				GPIO1_DIR
#define SW1_PIN				GPIO1_PIN
#define SW1_NUMPIN			(1<<20)
