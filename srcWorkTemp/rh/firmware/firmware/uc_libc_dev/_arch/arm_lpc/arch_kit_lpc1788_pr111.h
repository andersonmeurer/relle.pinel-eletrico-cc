#ifndef __ARCH_ARCH_KITLPC1788PR111_H
#define __ARCH_ARCH_KITLPC1788PR111_H


// ESTA ARQUITETURA UTILIZA O PROCESSADOR LPC1788
...
// LPC1788		FAST		FAST		FAST		FAST		FAST
...
////declaração do pino
//#define defPIN(port, mask)	(port * 256 + mask)
//#define outPIN(pin)			*(reg32*)(FIO_BASE_ADDR + (pin/256)*0x20) |= (1UL<<(pin&255))
//#define setPIN(pin)			*(reg32*)(FIO_BASE_ADDR + 0x18 + (pin/256)*0x20)  = (1UL<<(pin&255))
//#define clrPIN(pin)			*(reg32*)(FIO_BASE_ADDR + 0x1c + (pin/256)*0x20)  = (1UL<<(pin&255))
//#define getPIN(pin)		  ((*(reg32*)(FIO_BASE_ADDR + 0x14 + (pin/256)*0x20)  & (1UL<<(pin&255)))>0)
...
// valores temporários
#define TSC2046_CS_DIR  		GPIO2_DIR
#define TSC2046_CS_CLR			GPIO2_CLR
#define TSC2046_CS_SET			GPIO2_SET
#define TSC2046_CS  			BIT_23
...
#define LED1_DIR			GPIO4_DIR
#define LED1_OFF			GPIO4_CLR
#define LED1_ON				GPIO4_SET
#define LED1				BIT_30

#define LED2_DIR			GPIO4_DIR
#define LED2_OFF			GPIO4_CLR
#define LED2_ON				GPIO4_SET
#define LED2				BIT_29

#define LED3_DIR			GPIO4_DIR
#define LED3_OFF			GPIO4_CLR
#define LED3_ON				GPIO4_SET
#define LED3				BIT_28
...
#define USB_LED_DEVCNT1_OFF	LED2_OFF
...
// MEMÓRIAS DE VIDEO
#define VRAM_ADDR				SDRAM_BANK0_BASE_ADDR	// 1MB de video para cada pagina
#define VRAM_SIZE 				0x100000 // Tamnaho suficiente para display de 800x600 com 2 bytes por pixel
#define EMWIN_ADDR				SDRAM_BANK0_BASE_ADDR + VRAM_SIZE
#define EMWIN_SIZE				VRAM_SIZE
...
// ###################################################################################################################
// PWM 0
#define pwm0_ConfigPort() 		{ IOCON_P3_21 = 2; } // pino para PWM0[6] p3_21
